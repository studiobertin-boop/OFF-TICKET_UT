-- Migration: Update validate_status_transition to include ARCHIVIATA NON FINITA
-- Date: 2025-11-10
-- Description: Add the new ARCHIVIATA NON FINITA status to the validation function
