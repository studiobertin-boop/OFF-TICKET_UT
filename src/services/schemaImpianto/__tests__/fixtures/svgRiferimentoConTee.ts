...
export const RIGHE_SVG_RIFERIMENTO_CON_TEE = [
  ...
  `<path d="M 560 360 L 570 360" fill="none" stroke="#000" stroke-width="2" />`,
  `<path d="M 570 360 L 580 360" fill="none" stroke="#000" stroke-width="2" />`,
  ...
  `<g transform="translate(560 350)"><circle cx="10" cy="10" r="2.5" fill="#000" /></g>`,
