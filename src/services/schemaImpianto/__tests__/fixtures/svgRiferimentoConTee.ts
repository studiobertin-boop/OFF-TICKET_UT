...
export const RIGHE_SVG_RIFERIMENTO_CON_TEE = [
  ...
  `<path d="M 619 279 L 655 279" fill="none" stroke="#000" stroke-width="2" marker-end="url(#freccia)" />`,
  `<path d="M 655 279 L 691 279 L 691 259" fill="none" stroke="#000" stroke-width="2" />`,
  ...
  `<g transform="translate(643 267)"><circle cx="12" cy="12" r="5" fill="#000" /></g>`,
