 ...
 *
 * Generato l'ultima volta dal commit c27a862 ("feat(schema): il tubo sotto il TEE trascinato si
 * evidenzia"), l'ultimo prima del Task 6 del Blocco D3.
 */
export const RIGHE_SVG_RIFERIMENTO_CON_TEE = [
  ...
  `<path d="M 490 240 L 508 240 L 508 240 L 526 240" fill="none" stroke="#000" stroke-width="2" marker-end="url(#freccia)" />`,
  `<path d="M 526 240 L 544 240 L 544 240 L 562 240" fill="none" stroke="#000" stroke-width="2" />`,
  ...
  `<g transform="translate(105 603)"><path d="M -9 -8 L -9 8 L 0 0 Z M 9 -8 L 9 8 L 0 0 Z" fill="none" stroke="#000" stroke-width="2" stroke-linecap="round" /></g>`,
