...
export const RIGHE_SVG_RIFERIMENTO_CON_MURO = [
  ...
  `<rect x="146" y="82" width="18" height="16" fill="#fff" stroke="none" />`,
  `<path d="M 146 82 L 146 98 L 155 90 Z M 164 82 L 164 98 L 155 90 Z" fill="none" stroke="#000" stroke-width="2" stroke-linecap="round" />`,
  `<path d="M 400 200 L 435 200 L 435 260 L 470 260" fill="none" stroke="#000" stroke-width="2" />`,
  `<path d="M 100 410 L 100 470 L 500 470 L 500 510" fill="none" stroke="#000" stroke-width="2" stroke-dasharray="10 7" marker-end="url(#freccia)" />`,
  `<path d="M 350 410 L 350 470 L 500 470 L 500 510" fill="none" stroke="#000" stroke-width="2" stroke-dasharray="10 7" marker-end="url(#freccia)" />`,
  ...
  `<g transform="translate(105 885)"><rect x="-9" y="-8" width="18" height="16" fill="#fff" stroke="none" /><path d="M -9 -8 L -9 8 L 0 0 Z M 9 -8 L 9 8 L 0 0 Z" fill="none" stroke="#000" stroke-width="2" stroke-linecap="round" /></g>`,
  ...
  `<g transform="translate(105 1021)"><path d="M -30 0 L 30 0" fill="none" stroke="#000" stroke-width="2" stroke-dasharray="10 7" /></g>`,
