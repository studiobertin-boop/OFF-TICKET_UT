...
export const RIGHE_SVG_RIFERIMENTO_CON_MURO = [
  `<svg xmlns="http://www.w3.org/2000/svg" width="700" height="1078" viewBox="0 0 700 1078">`,
  `<rect width="700" height="1078" fill="#fff" />`,
  ...
  `<rect x="73" y="630" width="554" height="34" fill="none" stroke="#000" stroke-width="2" />`,
  `<text x="350" y="647" font-family="Arial, Helvetica, sans-serif" font-size="20" text-anchor="middle" dominant-baseline="central" fill="#000">LISTA APPARECCHIATURE</text>`,
  `<rect x="73" y="664" width="554" height="34" fill="none" stroke="#000" stroke-width="1" />`,
  `<line x1="203" y1="664" x2="203" y2="698" stroke="#000" stroke-width="1" />`,
  `<text x="138" y="681" font-family="Arial, Helvetica, sans-serif" font-size="16" text-anchor="middle" dominant-baseline="central" fill="#000">C1</text>`,
  `<text x="215" y="681" font-family="Arial, Helvetica, sans-serif" font-size="16" dominant-baseline="central" fill="#000">Compressore KAESER Mod. CSD 105 SFC</text>`,
  `<rect x="73" y="698" width="554" height="34" fill="none" stroke="#000" stroke-width="1" />`,
  `<line x1="203" y1="698" x2="203" y2="732" stroke="#000" stroke-width="1" />`,
  `<text x="138" y="715" font-family="Arial, Helvetica, sans-serif" font-size="16" text-anchor="middle" dominant-baseline="central" fill="#000">C1.1</text>`,
  `<text x="215" y="715" font-family="Arial, Helvetica, sans-serif" font-size="16" dominant-baseline="central" fill="#000">Serbatoio disoleatore AIR COM S.r.l. Mod. 25ADK1</text>`,
  `<rect x="73" y="732" width="554" height="34" fill="none" stroke="#000" stroke-width="1" />`,
  `<line x1="203" y1="732" x2="203" y2="766" stroke="#000" stroke-width="1" />`,
  `<text x="138" y="749" font-family="Arial, Helvetica, sans-serif" font-size="16" text-anchor="middle" dominant-baseline="central" fill="#000">C1.2</text>`,
  `<text x="215" y="749" font-family="Arial, Helvetica, sans-serif" font-size="16" dominant-baseline="central" fill="#000">Valvola di sicurezza PADOVAN VALERIO snc Mod. TW3</text>`,
  `<rect x="73" y="766" width="554" height="34" fill="none" stroke="#000" stroke-width="1" />`,
  `<line x1="203" y1="766" x2="203" y2="800" stroke="#000" stroke-width="1" />`,
  `<text x="138" y="783" font-family="Arial, Helvetica, sans-serif" font-size="16" text-anchor="middle" dominant-baseline="central" fill="#000">S1</text>`,
  `<text x="215" y="783" font-family="Arial, Helvetica, sans-serif" font-size="16" dominant-baseline="central" fill="#000">Serbatoio SICC TECH s.r.l. Mod. 2000-20011R2</text>`,
  `<rect x="73" y="800" width="554" height="34" fill="none" stroke="#000" stroke-width="1" />`,
  `<line x1="203" y1="800" x2="203" y2="834" stroke="#000" stroke-width="1" />`,
  `<text x="138" y="817" font-family="Arial, Helvetica, sans-serif" font-size="16" text-anchor="middle" dominant-baseline="central" fill="#000">S1.1</text>`,
  `<text x="215" y="817" font-family="Arial, Helvetica, sans-serif" font-size="16" dominant-baseline="central" fill="#000">Valvola di sicurezza PADOVAN VALERIO snc Mod. TA21</text>`,
  `<rect x="73" y="834" width="554" height="34" fill="none" stroke="#000" stroke-width="1" />`,
  `<line x1="203" y1="834" x2="203" y2="868" stroke="#000" stroke-width="1" />`,
  `<text x="138" y="851" font-family="Arial, Helvetica, sans-serif" font-size="16" text-anchor="middle" dominant-baseline="central" fill="#000">T</text>`,
  `<text x="215" y="851" font-family="Arial, Helvetica, sans-serif" font-size="16" dominant-baseline="central" fill="#000">Tanica raccolta condense</text>`,
  `<rect x="73" y="868" width="554" height="34" fill="none" stroke="#000" stroke-width="1" />`,
  `<line x1="203" y1="868" x2="203" y2="902" stroke="#000" stroke-width="1" />`,
  `<g transform="translate(138 885)"><rect x="-9" y="-4.5" width="18" height="9" fill="#fff" stroke="none" /><path d="M -9 -4.5 L -9 4.5 L 0 0 Z M 9 -4.5 L 9 4.5 L 0 0 Z" fill="none" stroke="#000" stroke-width="2" stroke-linecap="round" /></g>`,
  `<text x="215" y="885" font-family="Arial, Helvetica, sans-serif" font-size="16" dominant-baseline="central" fill="#000">Valvola di intercettazione</text>`,
  `<rect x="73" y="902" width="554" height="34" fill="none" stroke="#000" stroke-width="1" />`,
  `<line x1="203" y1="902" x2="203" y2="936" stroke="#000" stroke-width="1" />`,
  `<g transform="translate(138 919)"><path d="M -4.5 -13 L 4.5 -13 L 0 -4 Z M -4.5 5 L 4.5 5 L 0 -4 Z" fill="none" stroke="#000" stroke-width="2" stroke-linecap="round" /><path d="M 0 5 L 0 13" fill="none" stroke="#000" stroke-width="2" stroke-linecap="round" /></g>`,
  `<text x="215" y="919" font-family="Arial, Helvetica, sans-serif" font-size="16" dominant-baseline="central" fill="#000">Valvola di scarico</text>`,
  `<rect x="73" y="936" width="554" height="34" fill="none" stroke="#000" stroke-width="1" />`,
  `<line x1="203" y1="936" x2="203" y2="970" stroke="#000" stroke-width="1" />`,
  `<g transform="translate(138 953)"><path d="M -30 0 L 30 0" fill="none" stroke="#000" stroke-width="2" /></g>`,
  `<text x="215" y="953" font-family="Arial, Helvetica, sans-serif" font-size="16" dominant-baseline="central" fill="#000">Tubazione rigida</text>`,
  `<rect x="73" y="970" width="554" height="34" fill="none" stroke="#000" stroke-width="1" />`,
  `<line x1="203" y1="970" x2="203" y2="1004" stroke="#000" stroke-width="1" />`,
  `<g transform="translate(138 987)"><path d="M -30 0 Q -25 5 -20 0 Q -15 -5 -10 0 Q -5 5 0 0 Q 5 -5 10 0 Q 15 5 20 0 Q 25 0 30 0" fill="none" stroke="#000" stroke-width="2" /></g>`,
  `<text x="215" y="987" font-family="Arial, Helvetica, sans-serif" font-size="16" dominant-baseline="central" fill="#000">Tubazione flessibile</text>`,
  `<rect x="73" y="1004" width="554" height="34" fill="none" stroke="#000" stroke-width="1" />`,
  `<line x1="203" y1="1004" x2="203" y2="1038" stroke="#000" stroke-width="1" />`,
  `<g transform="translate(138 1021)"><path d="M -30 0 L 30 0" fill="none" stroke="#000" stroke-width="2" stroke-dasharray="7 10" /></g>`,
  `<text x="215" y="1021" font-family="Arial, Helvetica, sans-serif" font-size="16" dominant-baseline="central" fill="#000">Linea condense</text>`,
  `</svg>`
]
