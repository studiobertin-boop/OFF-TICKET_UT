...
export const RIGHE_SVG_RIFERIMENTO_CON_MURO = [
  ...
  `<path d="M 100 160 L 100 140 L 216 140 L 216 360 L 250 360" fill="none" stroke="#000" stroke-width="2" />`,
