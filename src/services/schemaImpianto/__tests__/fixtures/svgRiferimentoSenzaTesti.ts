...
export const RIGHE_SVG_RIFERIMENTO_SENZA_TESTI = [
  ...
  `<rect x="130" y="524" width="650" height="34" fill="none" stroke="#000" stroke-width="1" />`,
  `<line x1="260" y1="524" x2="260" y2="558" stroke="#000" stroke-width="1" />`,
  `<text x="195" y="541" font-family="Arial, Helvetica, sans-serif" font-size="16" text-anchor="middle" dominant-baseline="central" fill="#000">C1</text>`,
  `<text x="272" y="541" font-family="Arial, Helvetica, sans-serif" font-size="16" dominant-baseline="central" fill="#000">Compressore KAESER Mod. CSD 105 SFC</text>`,
  `<rect x="130" y="558" width="650" height="34" fill="none" stroke="#000" stroke-width="1" />`,
  `<line x1="260" y1="558" x2="260" y2="592" stroke="#000" stroke-width="1" />`,
  `<text x="195" y="575" font-family="Arial, Helvetica, sans-serif" font-size="16" text-anchor="middle" dominant-baseline="central" fill="#000">S1</text>`,
  `<text x="272" y="575" font-family="Arial, Helvetica, sans-serif" font-size="16" dominant-baseline="central" fill="#000">Serbatoio SICC TECH s.r.l. Mod. 2000-20011R2</text>`,
  `<rect x="130" y="592" width="650" height="34" fill="none" stroke="#000" stroke-width="1" />`,
  `<line x1="260" y1="592" x2="260" y2="626" stroke="#000" stroke-width="1" />`,
  `<text x="195" y="609" font-family="Arial, Helvetica, sans-serif" font-size="16" text-anchor="middle" dominant-baseline="central" fill="#000">S1.1</text>`,
  `<text x="272" y="609" font-family="Arial, Helvetica, sans-serif" font-size="16" dominant-baseline="central" fill="#000">Valvola di sicurezza PADOVAN VALERIO snc Mod. TA21</text>`,
  `<rect x="130" y="626" width="650" height="34" fill="none" stroke="#000" stroke-width="1" />`,
  `<line x1="260" y1="626" x2="260" y2="660" stroke="#000" stroke-width="1" />`,
  `<g transform="translate(195 643)"><rect x="-9" y="-4.5" width="18" height="9" fill="#fff" stroke="none" /><path d="M -9 -4.5 L -9 4.5 L 0 0 Z M 9 -4.5 L 9 4.5 L 0 0 Z" fill="none" stroke="#000" stroke-width="2" stroke-linecap="round" /></g>`,
  `<text x="272" y="643" font-family="Arial, Helvetica, sans-serif" font-size="16" dominant-baseline="central" fill="#000">Valvola di intercettazione</text>`,
  `<rect x="130" y="660" width="650" height="34" fill="none" stroke="#000" stroke-width="1" />`,
  `<line x1="260" y1="660" x2="260" y2="694" stroke="#000" stroke-width="1" />`,
  `<g transform="translate(195 677)"><path d="M -4.5 -13 L 4.5 -13 L 0 -4 Z M -4.5 5 L 4.5 5 L 0 -4 Z" fill="none" stroke="#000" stroke-width="2" stroke-linecap="round" /><path d="M 0 5 L 0 13" fill="none" stroke="#000" stroke-width="2" stroke-linecap="round" /></g>`,
  `<text x="272" y="677" font-family="Arial, Helvetica, sans-serif" font-size="16" dominant-baseline="central" fill="#000">Valvola di scarico</text>`,
  `<rect x="130" y="694" width="650" height="34" fill="none" stroke="#000" stroke-width="1" />`,
  `<line x1="260" y1="694" x2="260" y2="728" stroke="#000" stroke-width="1" />`,
  `<g transform="translate(195 711)"><path d="M -30 0 L 30 0" fill="none" stroke="#000" stroke-width="2" /></g>`,
  `<text x="272" y="711" font-family="Arial, Helvetica, sans-serif" font-size="16" dominant-baseline="central" fill="#000">Tubazione rigida</text>`,
  `<rect x="130" y="728" width="650" height="34" fill="none" stroke="#000" stroke-width="1" />`,
  `<line x1="260" y1="728" x2="260" y2="762" stroke="#000" stroke-width="1" />`,
  `<g transform="translate(195 745)"><path d="M -30 0 Q -25 5 -20 0 Q -15 -5 -10 0 Q -5 5 0 0 Q 5 -5 10 0 Q 15 5 20 0 Q 25 0 30 0" fill="none" stroke="#000" stroke-width="2" /></g>`,
  `<text x="272" y="745" font-family="Arial, Helvetica, sans-serif" font-size="16" dominant-baseline="central" fill="#000">Tubazione flessibile</text>`,
  `</svg>`
]
