...
export const RIGHE_SVG_RIFERIMENTO_SENZA_TESTI = [
  ...
  `<path d="M 490 240 L 526 240 L 526 240 L 562 240" fill="none" stroke="#000" stroke-width="2" />`,
  ...
  `<g transform="translate(105 637)"><path d="M -4.5 -13 L 4.5 -13 L 0 -4 Z M -4.5 5 L 4.5 5 L 0 -4 Z" fill="none" stroke="#000" stroke-width="2" stroke-linecap="round" /><path d="M 0 5 L 0 13" fill="none" stroke="#000" stroke-width="2" stroke-linecap="round" /></g>`,
