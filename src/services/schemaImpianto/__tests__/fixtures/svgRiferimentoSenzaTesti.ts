 ...
 *
 * Generato l'ultima volta dal commit 7a7bfb0 ("feat(schema-impianto): il testo libero entra nel
 * modello e nel salvataggio"), l'ultimo prima del Task 7 del Blocco C2.
 */
